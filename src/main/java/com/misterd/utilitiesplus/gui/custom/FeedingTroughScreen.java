...
public class FeedingTroughScreen extends AbstractContainerScreen<FeedingTroughMenu> {
    private static final Identifier GUI_TEXTURE =
            Identifier.fromNamespaceAndPath("utilitiesplus", "textures/gui/feeding_trough_gui.png");

    public FeedingTroughScreen(FeedingTroughMenu menu, Inventory playerInventory, Component title) {
